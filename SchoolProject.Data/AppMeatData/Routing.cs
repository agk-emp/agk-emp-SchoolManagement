namespace SchoolProject.Data.AppMeatData
{
    public static class Routing
    {
        ...
        public static class UserRouting
        {
            ...
            public const string ReplacePassword = AccountVersionOneRoute + "ReplacePassword";
            public const string ConfirmResetPassword = AccountVersionOneRoute + "ConfirmResetPassword";
        ...
        public static class InstructorRouting
        {
            ...
            public const string AddInstructor = InstructorsVersionOneRoute + "AddInstructor";
        }
    }
}
